...
public class OperandStack{
	...
	protected Object clone(){
        ...
        newstack.track = (ArrayList) this.track.clone();
		return newstack;
	}
   ...
   */
	...
	public Type pop(){
		...
		int x = (Integer)track.remove(size()-1);
		return e;
	}
    public Object[] pop2(){
        Type e = (Type) stack.remove(size()-1);
        int x = (Integer)track.remove(size()-1);
        return new Object[]{e, x};
    }
	 ...
	 */
	public void push(Type type, int x){
		if (type == null) {
